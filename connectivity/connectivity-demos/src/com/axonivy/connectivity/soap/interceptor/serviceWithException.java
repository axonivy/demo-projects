...
public class serviceWithException
  ...
  @jakarta.jws.WebResult(name = "exceptionMessage")
  public java.lang.String call(@jakarta.jws.WebParam(name = "throwException") java.lang.Boolean throwException,
      @jakarta.jws.WebParam(name = "exceptionMessage") java.lang.String exceptionMessage)
