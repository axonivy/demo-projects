...
public class PersonFactory {
  ...
  public static final Person create() {
    ...
    person.setFirstName(FIRST_NAMES.get(RANDOM.nextInt(FIRST_NAMES.size())));
    person.setLastName(LAST_NAMES.get(RANDOM.nextInt(LAST_NAMES.size())));
    ...
    person.setBirthDate(new Date(year.getValue(), month.getValue(), day));
    return person;
  }
}
